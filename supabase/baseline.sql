Warning: truncated output (original token count: 476600)
... 857824 bytes omitted ...
...
CREATE UNIQUE INDEX IF NOT EXISTS "ai_models_one_default_pe…212152 tokens truncated…endar_appointments set meeting_request_id=case when meeting_last_error='google_failure' and meeting_received_at is not null then gen_random_uuid() else meeting_request_id end,
