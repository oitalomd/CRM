Warning: truncated output (original token count: 79928)
Total output lines: 10193
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      channel_sessions: {
        Row: {
          archiv…19928 tokens truncated…       organization_id: string
          reason: string | null
          seq: number
          to_stage: string
        }
      ...
      organization_data_planes: {
        Row: {
          organization_id: string
          status: string
          connection_uri_encrypted: string
          connection_uri_iv: string
          connection_uri_tag: string
        ...
        Relationships: [
          {
            foreignKeyName: "organization_data_planes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: true
            referencedRelation: "organizations"
            referencedColumns: ["id"]
